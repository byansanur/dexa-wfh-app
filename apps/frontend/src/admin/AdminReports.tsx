            ...
            <div className="flex items-center gap-2">
              ...
              <Input 
                ...
                onChange={e => {
                  ...
                  if (reportEndDate && e.target.value > reportEndDate) setReportEndDate(e.target.value);
                }} 
            ...
            <div className="flex items-center gap-2">
              ...
              <Input 
                ...
                onChange={e => {
                  ...
                  if (reportStartDate && e.target.value < reportStartDate) setReportStartDate(e.target.value);
                }} 
                containerStyle={{ marginBottom: 0 }} 
              />
              <select 
